...
<form
  ...
  <div class="overflow-hidden">
    <div class="flex flex-col md:flex-row -mx-2">
      <div class="w-full md:w-1/2 px-2 mb-2">
        ...
        <input type="text" name="name" id="name" class="form-input" required maxlength="191" value="{{ old('name', $business->name) }}">
        @error('name')
  ...
  <div class="mb-2">
    ...
    <textarea class="form-input" name="description" id ="description">{{ old('description', $business->description) }}</textarea>
    @error('description')
    <p class="text-xs text-red-500">{{ $message }}</p>
    @enderror
  </div>
  ...
  <div class="overflow-hidden">
    <div class="flex flex-col md:flex-row -mx-2">
      <div class="w-full md:w-1/2 lg:w-1/4 px-2 mb-2">
        ...
        <input type="tel" name="phone" id="phone" class="form-input" maxlength="9" value="{{ old('phone', $business->phone) }}">
        @error('phone')
        <p class="text-xs text-red-500">{{ $message }}</p>
        @enderror
      </div> 
      <div class="w-full md:w-1/2 lg:w-1/4 px-2 mb-2">
        ...
        <input type="tel" name="whatsapp" id="whatsapp" class="form-input" maxlength="9" value="{{ old('whatsapp', $business->whatsapp) }}">
        @error('whatsapp')
        <p class="text-xs text-red-500">{{ $message }}</p>
        @enderror
      </div>
      <div class="w-full md:w-1/2 lg:w-1/4 px-2 mb-2">
        ...
        <input type="email" name="email" id="email" class="form-input" maxlength="191" value="{{ old('email', $business->email) }}">
        @error('email')
        <p class="text-xs text-red-500">{{ $message }}</p>
        @enderror
      </div>
      <div class="w-full md:w-1/2 lg:w-1/4 px-2 mb-2">
        ...
        <input type="text" name="website" id="website" class="form-input" maxlength="191" value="{{ old('website', $business->website) }}">
        @error('website')
        <p class="text-xs text-red-500">{{ $message }}</p>
        @enderror
      </div>
  ...
  <div class="overflow-hidden">
    <div class="flex flex-col md:flex-row -mx-2">
      <div class="w-full md:w-2/3 px-2 mb-2">
        ...
        <input type="text" name="address" id="address" class="form-input" maxlength="191" required value="{{ old('address', $business->address) }}">
        @error('address')
        <p class="text-xs text-red-500">{{ $message }}</p>
        @enderror
      </div>
    ...
    <div class="flex flex-col md:flex-row -mx-2">
      ...
      <div class="w-full md:w-1/3 px-2 mb-2">
        ...
        <p><label class="form-label">
          <input type="radio" name="is_delivery" value="0" {{ old('is_delivery', $business->is_delivery) == 0 ? 'checked' : '' }}> No</label> <label class="form-label">
          <input type="radio" name="is_delivery" value="1" {{ old('is_delivery', $business->is_delivery) == 1 ? 'checked' : '' }}> Sí</label></p>
        @error('is_delivery')
        <p class="text-xs text-red-500">{{ $message }}</p>
        @enderror
      </div>
      <div class="w-full md:w-1/3 px-2 mb-2">
        ...
        <p><label class="form-label">
          <input type="radio" name="is_takeout" value="0" {{ old('is_takeout', $business->is_takeout) == 0 ? 'checked' : '' }}> No</label> <label class="form-label">
          <input type="radio" name="is_takeout" value="1" {{ old('is_takeout', $business->is_takeout) == 1 ? 'checked' : '' }}> Sí</label></p>
        @error('is_takeout')
        <p class="text-xs text-red-500">{{ $message }}</p>
        @enderror
      </div>
